...
public class Pixel {
    ...
    public int getAlpha() {
        ...
        /*
         * get the value at the location from the picture as a 32 bit int with alpha, red, green,
         * blue each taking 8 bits from left to right
         */
    ...
    public String toString() {
        return "Pixel row=" + getRow() + " col=" + getCol() + " red=" + getRed() + " green="
