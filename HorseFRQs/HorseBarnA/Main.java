class Main {
  public static void main(String[] args) {
    ...
    System.out.println("Silver appears in stall index " + findHorseSpace(spaces, "Silver") + ".");// Should be index 2.

    System.out.println("Trigger appears in stall index " + findHorseSpace(spaces, "Trigger") + ".");// Should be 0.

    System.out.println("Bubba appears in stall index " + findHorseSpace(spaces, "Bubba") + ".");// Should be -1.
  }
