...
public class JumpThoseHurdles {
	...
	/**
	 * This method assumes the Robot is named hurdler and is facing East This moves hurdler to the
	 * next wall (hurdle). It returns the number of moves it took to get to the hurdle
	 */
	...
	/**
	 * This method assumes the Robot is named hurdler, is facing East and is at the base of the
	 * hurdle. This moves the Robot to the top of the hurdle so that it can clear the wall.
	 * 
	...
	/**
	 * Moves the Robot (hurdler) over the wall and moves it to the ground so that the Robot has its
